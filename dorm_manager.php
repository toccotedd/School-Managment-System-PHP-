...
<font color="red"size="5px" style="margin-left:110px;"><?php if(isset($_POST['dorm_register'])) echo "".$error.""?></font>
                 <fieldset>
					 <form action="dorm_manager.php" method="POST">
					Dorm No: &nbsp &nbsp &nbsp &nbsp <input style="width:230px;"  name="dorm_no" type="number" />
					<div class="gab"></div>
					Black No: &nbsp &nbsp &nbsp &nbsp <input style="width:230px;" name="black_no" type="number" onKeyPress="return letteronly(event)" />
					<div class="gab"></div>
					
					<div class="gab"></div>
					For Which: &nbsp &nbsp &nbsp<select name="forwhich" style="width:247px;height:30px;margin-top:5px;">
